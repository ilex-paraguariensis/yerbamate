...
const SocketAPIHook = () => {
    ...
    const { sendMessage, sendJsonMessage, lastMessage, readyState } = useWebSocket(socketUrl, connectionStatusListener, true);
    ...
    return {
        sendMessage, sendJsonMessage, lastMessage, connection_state: readyState, messageHistory, socketUrl, setSocketUrl, setConnectionStatusListener,
